...
<div class="body-wrapper">
    ...
    <div class="ltn__slider-area ltn__slider-3 ltn__slider-6 section-bg-1">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white---">
                                        ...
                                        <div class="slide-item-info">
                                            <div class="slide-item-info-inner ltn__slide-animation">
                                                ...
                                                <div class="btn-wrapper animated">
                                                    <a href="service.html" class="theme-btn-1 btn btn-round">
                                                        Shop Now
                                                    </a>
                                                </div>
                                            </div>
            ...
            <!-- ltn__slide-item  -->
            <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---"
                data-bs-bg="{{ asset('asset/img/slider/slider2.png') }}">
                <div class="ltn__slide-item-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html">
                                <img src="{{ asset('asset/img/banner/banner.jpg') }}" alt="Banner Image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="{{ asset('asset/img/product/celulares/xiomi.png') }}" alt="#" />
                            </a>
                                ...
                                <ul>
                                    ...
                                    <li class="add-to-cart">
                                        <a href="#" title="Añadir a favorito" data-bs-toggle="modal"
                                            ...
                                            <span class="cart-text d-none d-xl-block">
                                                Añadir a favorito
                                            </span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="{{ asset('asset/img/product/celulares/fotos3.jpg') }}" alt="#" />
                            </a>
                            <div class="product-badge">
                                <ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="{{ asset('asset/img/product/celulares/fotos1.jpg') }}" alt="#" />
                            </a>
                            <div class="product-badge">
                                <ul>
                        ...
                        <div class="product-info">
                            <h2 class="product-title">
                                <a href="product-details.html">The White Rose</a>
                            </h2>
                            <div class="product-price">
                                <span>S/16.00</span>
                                <del>S/19.00</del>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="{{ asset('asset/img/product/celulares/foto2.jpg') }}" alt="#" />
                            </a>
                            <div class="product-badge">
                                <ul>
                        ...
                        <div class="product-info">
                            <h2 class="product-title">
                                <a href="product-details.html">Assorted Roses</a>
                            </h2>
                            <div class="product-price">
                                <span>S/17.00</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="{{ asset('asset/img/product/celulares/xiomi2.webp') }}" alt="#" />
                            </a>
                            <div class="product-badge">
                                <ul>
                                    <li class="badge-1">Hot</li>
                        ...
                        <div class="product-info">
                            <h2 class="product-title">
                                <a href="product-details.html">Roses Surprise</a>
                            </h2>
                            <div class="product-price">
                                <span>S/12.00</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        ...
                        <div class="product-info">
                            <h2 class="product-title">
                                <a href="product-details.html">Tropical Peace Lily</a>
                            </h2>
                            <div class="product-price">
                                <span>S/14</span>
                                <del>S/25.00</del>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html">
                                <img src="{{ asset('asset/img/banner/banner1.jpg') }}" alt="Banner Image" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="{{ route('shop.index') }}">
                                <img src="{{ asset('asset/img/banner/publi.webp') }}" alt="Banner Image" />
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="ltn__blog-area pt-60 pb-30">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h1 class="section-title section-title-border">Ultimas noticias</h1>
                    </div>
                </div>
            </div>
            <div class="row ltn__blog-slider-one-active slick-arrow-1">
                    ...
                    <div class="ltn__blog-item">
                        <div class="ltn__blog-img">
                            <a href="blog-details.html">
                                <img src="{{ asset('asset/img/blog/iphone.webp') }}" alt="#" />
                            </a>
                        </div>
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title blog-title-line">
                                <a href="blog-details.html">Lanzamiento de iphone 15</a>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        ...
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title blog-title-line">
                                <a href="blog-details.html">Errores en lanzamiento</a>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        <div class="ltn__blog-img">
                            <a href="blog-details.html">
                                <img src="{{ asset('asset/img/blog/samsung.jpg') }}" alt="#" />
                            </a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                            ...
                            <h3 class="ltn__blog-title blog-title-line">
                                <a href="blog-details.html">Nuevo Samsung Flip 212</a>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        ...
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title blog-title-line">
                                <a href="blog-details.html">
                                    Lorem ipsum dolor sit amet con adipisicing elit sed
                                </a>
                            </h3>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        <div class="ltn__blog-img">
                            <a href="blog-details.html">
                                <img src="{{ asset('asset/img/blog/5.jpg') }}" alt="#" />
                            </a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
            ...
            <div class="row ltn__brand-logo-active">
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="{{ asset('asset/img/brand-logo/1.') }}" alt="Brand Logo" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="{{ asset('asset/img/brand-logo/2.') }}" alt="Brand Logo" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="{{ asset('asset/img/brand-logo/3.') }}" alt="Brand Logo" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="{{ asset('asset/img/brand-logo/4.') }}" alt="Brand Logo" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="{{ asset('asset/img/brand-logo/5.') }}" alt="Brand Logo" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
