                ...
                <div class="ltn__main-menu">
                  <ul>
                    ...
                    <li class="menu-icon">
                      ...
                      <ul class="mega-menu">
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="{{route('shop.index')}}">Shop Lar</a>
                            </li>
                    ...
                    <li class="menu-icon">
                      <a href="#">Tecnologia</a>
                      <ul>
                        <li><a href="{{route('shop.index')}}">Celulares</a></li>
                        <li><a href="shop-grid.html">TV'S</a></li>
                        {{--
                        <li><a href="shop-left-sidebar.html">Tvs</a></li>
                        --}}
                        <li>
                          <a href="shop-right-sidebar.html">Refrigeradoras</a>
                        </li>
