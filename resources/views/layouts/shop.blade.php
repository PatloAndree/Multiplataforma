                    ...
                    <div class="ltn__breadcrumb-inner text-center">
                        ...
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                ...
                                <li> <?php echo $nombre_categoria->nombre_categoria ?> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row" id="productContainer">
                                    ...
                                    @foreach ($productos as $producto)
                                        <div class="col-xl-3 col-sm-6 col-12" >
                                            <div class="ltn__product-item text-center  border rounded">
                                                        ...
                                                        <div class="col-md-12">
                                                            <h2 class="product-title">
                                                                <a href="{{route('productodetalle.index',$nuevoid)}}">
                                                                    <?php echo Str::limit( $producto['nombre_producto'] , 25, '...') ?>     
                                                                </a>
                                                            </h2>
                                                            <div class="product-price">
                                                                <span>S/. <?php echo $producto['precio_actual'] ?></span>
                                                                <span><del style="color:#FE0000">S/. <?php echo $producto['precio_actual'] + 42?> </del> </span>
                                        ...
                                        <div class="col-lg-12 border rounded">
                                            <div class="ltn__product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class=" product-hover-action-2">
                                                        <ul>
                                                            <li class="">
                                                                <a href="#" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                                                    <i class="icon-magnifier"></i>
...
<script>
    window.onload = buildProductElements;
    
    async function buildProductElements() {
        const container = document.getElementById('productContainer');
        
            $('#productContainer').waitMe({
            effect : 'timer',
            text : 'cargando',
