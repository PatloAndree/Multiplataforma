                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="add-to-cart">
                                                                    <a href="#" title="Add to Cart"
                                                                        ...
                                                                        <span class="cart-text d-none d-xl-block">Añadir a
                                                                            favorito</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h2 class="product-title">
                                                                    <a
                                                                        href="{{ route('productodetalle.index', $nuevoid) }}">
                                                ...
                                                <div class="ltn__product-item">
                                                    ...
                                                    <div class="product-info">
                                                        <h2 class="product-title"><a
                                                                href="product-details.html"><?php echo $producto['marca_producto']; ?></a></h2>
                                                        <div class="product-price">
                                                            <span><?php echo $producto['precio_actual']; ?></span>
                                                        </div>
                    ...
                    <div class="col-lg-2 mb-100">
                        <aside class="sidebar ltn__shop-sidebar">
                            ...
                            <div class="widget ltn__menu-widget">
                                ...
                                <ul>
                                    @foreach ($marcas_celular as $marca)
                                        <li>
