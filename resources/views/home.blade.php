    ...
    <div class="body-wrapper">
        ...
        <div class="ltn__slider-area ltn__slider-3 ltn__slider-6 section-bg-1">
            <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white---">
                <!-- ltn__slide-item  -->
                <div class="ltn__slide-item ltn__slide-item-8  bg-image img-fluid mw-100"
                    data-bs-bg="https://www.lacuracao.pe/media/wysiwyg/IMG_0206.jpeg">
                ...
                <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---"
                    data-bs-bg="https://www.lacuracao.pe/media/wysiwyg/IMG_0232.jpeg">
                    <div class="ltn__slide-item-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 align-self-center">
                ...
                {{-- tercerslider --}}
                <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---"
                    data-bs-bg="https://www.lacuracao.pe/media/wysiwyg/IMG_0233.jpeg">
                    <div class="ltn__slide-item-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 align-self-center">
        ...
        <!-- BANNER AREA START -->
        <div class="ltn__banner-area border-bottom blue-gradient bg-dark mb-3 z-depth-1 mt-5">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-4 col-md-6 mt-3">
                        <div class="ltn__banner-item">
                            <div class="ltn__banner-img">
                                <a href="shop.html"><img src="https://www.lacuracao.pe/media/wysiwyg/IMG_0224.jpeg"
                                        class=" bg-image img-fluid mw-100 rounded" alt="Banner Image"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-3">
                        <div class="ltn__banner-item">
                            <div class="ltn__banner-img">
                                <a href="shop.html"><img src="https://www.lacuracao.pe/media/wysiwyg/IMG_0222.jpeg"
                                        class=" bg-image img-fluid mw-100 rounded" alt="Banner Image"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-3">
                        <div class="ltn__banner-item">
                            <div class="ltn__banner-img">
                                <a href="shop.html"><img src="https://www.lacuracao.pe/media/wysiwyg/IMG_0241.jpeg"
                                        class=" bg-image img-fluid mw-100 rounded" alt="Banner Image"></a>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="#"
                                                                ...
                                                                title="Añadir a favorito" data-bs-toggle="modal"
                                                                data-bs-target="#add_to_cart_modal">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="ltn__banner-item">
                            <div class="ltn__banner-img">
                                <a href="https://www.carsa.pe/televisor-smart-indurama-fhd-43-pulgadas-43tikfcfhd-6921041103588"
                                    target="_blank"><img src="{{ asset('asset/img/banner/banner_ca2.webp') }}"
                                        alt="Banner Image"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="ltn__banner-item">
                            <div class="ltn__banner-img">
                                <a href="https://www.carsa.pe/televisor-50-samsung-led-4k-ultra-hd-smart-un50au7090gxpe-2021-8806092858718"
                                    target="_blank"> <img src="{{ asset('asset/img/banner/banner_ca.webp') }}"
                                        alt="Banner Image"></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ltn__banner-item">
                            <div class="ltn__banner-img">
                                <a href="https://www.coolbox.pe/departamento-gamer" target="_blank"><img
                                        src="{{ asset('asset/img/banner/publi.webp') }}" alt="Banner Image"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- PRODUCT SLIDER LAPTOPS START -->
        <div class="ltn__product-slider-area ltn__product-gutter ">
            <div class="container ">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area text-center">
                            <h1 class="section-title section-title-border">Zona computo top</h1>
                        </div>
                    </div>
                </div>
                <div class="row ltn__product-slider-item-four-active slick-arrow-1">
                    <!-- ltn__product-item -->
                    @foreach ($gamer as $producto)
                        <div class="col-12">
        ...
        <div class="ltn__product-slider-area ltn__product-gutter ">
            <div class="container ">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area text-center">
                            <h1 class="section-title section-title-border">Zona Videojuegos top</h1>
                        </div>
                    </div>
                </div>
                <div class="row ltn__product-slider-item-four-active slick-arrow-1">
                    <!-- ltn__product-item -->
                    @foreach ($videojuegos as $producto)
                        <div class="col-12">
                            <div class="ltn__product-item text-center rounded-3 text-center borde-caja"">
                                <div class=" product-img">
                                @php
        ...
        <div class="container">
            <div class="ltn__slider-area ltn__slider-3 ltn__slider-6 section-bg-1">
                <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white---">
                    <!-- ltn__slide-item  -->
                    <div class="ltn__slide-item ltn__slide-item-8  bg-image img-fluid mw-100"
                        data-bs-bg="https://www.lacuracao.pe/media/wysiwyg/IMG_0279.jpeg">
                        <div class="ltn__slide-item-inner">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 align-self-center">
                    ...
                    <!-- ltn__slide-item  -->
                    <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---"
                        data-bs-bg="https://www.lacuracao.pe/media/wysiwyg/lc-sliders-b2c-010124-12-1_1.jpg">
                        <div class="ltn__slide-item-inner">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 align-self-center">
                    ...
                    {{-- tercerslider --}}
                    <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---"
                        data-bs-bg="https://www.lacuracao.pe/media/wysiwyg/lc-sliders-b2c-010124-11-1_1.jpg">
                        <div class="ltn__slide-item-inner">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 align-self-center">
        ...
        <div class="ltn__brand-logo-area  ltn__brand-logo-1 section-bg-1 pt-35 pb-35 plr--5">
            <div class="container-fluid">
                <a href="shop.html"><img src="{{ asset('asset/img/banner/banner_ejemplo.webp') }}"
                        alt="Banner Image"></a>
            </div>
        </div>
        <!-- BRAND LOGO AREA END -->
